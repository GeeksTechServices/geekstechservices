          ...
          <div className='container mx-auto max-w-6xl px-6'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
              {relatedPosts.map((post) => (
                ...
                >
                  <Card className='glass border-white/10 hover:border-[var(--accent)]/30 transition-all duration-300 overflow-hidden'>
                    ...
                    <div className='p-4 space-y-2'>
                      <h4 className='text-sm font-medium text-white group-hover:text-[var(--accent)] transition-colors duration-300 line-clamp-2'>
                        {post.title}
                      </h4>
