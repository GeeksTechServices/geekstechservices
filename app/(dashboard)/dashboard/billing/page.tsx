            ...
            <div className='flex items-center justify-between'>
              <div>
                ...
                <p className='text-xs text-muted-foreground'>
                  Pro — $<AnimatedCounter value={29} duration={1000} /> / month
                </p>
              </div>
              <GlowingButton glowColor='green' className='text-sm px-3 py-1'>
                Upgrade
              </GlowingButton>
            </div>
            <UsageBreakdown />
        ...
        <div className='space-y-6'>
          ...
          <Card>
            ...
            <CardContent className='flex justify-center'>
              <DonutChart data={spendingData} centerText='$29' size={140} />
            </CardContent>
          </Card>
