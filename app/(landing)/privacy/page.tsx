...
export default function PrivacyPage() {
  return (
    <main className='min-h-screen bg-black/95 text-white'>
      <div className='container mx-auto max-w-6xl px-6 py-20 grid gap-12 lg:grid-cols-[280px_minmax(0,1fr)] items-start'>
        <header className='lg:col-span-2 flex flex-col gap-4'>
          <div className='flex items-center justify-between'>
            <div>
              <p className='inline-flex items-center gap-2 rounded-full bg-white/3 px-3 py-1 text-sm font-medium text-white/90'>
                Legal
              </p>
            </div>
          ...
          <div className='pt-2'>
            ...
            <p className='text-gray-300 mt-2 max-w-xl'>
              This policy explains how we collect and use data on
              GeekStechServices.
            </p>
          </div>
        </header>
        ...
        <nav className='hidden lg:block sticky top-28'>
          <div className='rounded-lg bg-white/3 p-4 text-sm text-gray-200 ring-1 ring-white/5'>
        ...
        <div>
          <article className='prose prose-invert prose-lg max-w-none text-gray-200 bg-white/2 p-8 rounded-xl shadow-xl ring-1 ring-white/5'>
            <h1
              id='introduction'
              className='scroll-mt-28 text-3xl font-extrabold text-white'
            >
              Privacy Policy
            </h1>
            ...
            <h2
              id='interpretation'
              className='scroll-mt-28 text-2xl font-semibold text-white'
            >
            ...
            <ul className='list-disc pl-5 space-y-3 mt-3'>
              ...
              <li>
                <p>
                  ...
                  GeeksTechServices, 479 Peradeniya Rd, Kandy 20000.
                </p>
              </li>
              <li>
                <p>
              ...
              <li>
                <p>
                  <strong>Website</strong> refers to geekstechservices.com,
                  accessible from{" "}
                  <a
                    href='https://geekstechservices.com'
                    rel='external nofollow noopener'
                    target='_blank'
                  >
                    https://geekstechservices.com
                  </a>
                </p>
              </li>
              <li>
            ...
            <h3 id='how-we-use' className='text-lg font-medium text-white mt-4'>
            ...
            <ul>
              <li>
                <p>By email: hello@geekstechservices.com</p>
              </li>
              <li>
                <p>
                  By visiting this page on our website:{" "}
                  <a
                    href='https://geekstechservices.com/contact'
                    rel='external nofollow noopener'
                    target='_blank'
                    className='text-sky-400 hover:text-sky-300 underline'
                  >
                    geekstechservices.com/contact
                  </a>
                </p>
              </li>
            </ul>
